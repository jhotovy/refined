 ...
 * Refined Changes:
 *
 * Update copy only ("topic"->"discussion", "forum"->"category", etc)
 */
?>
		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				<legend>
					...
					<?php
						if ( bbp_is_topic_edit() )
							...
							bbp_is_single_forum() ? printf( __( 'Create New Topic in &ldquo;%s&rdquo;', 'bbpress' ), bbp_get_forum_title() ) : _e( 'Create New Discussion', 'bbpress' );
					?>
				...
				<div>
					...
					<p>
						<label for="bbp_topic_title"><?php printf( __( 'Discussion Title:', 'bbpress' ), bbp_get_title_max_length() ); ?></label><br />
					...
					<?php if ( !bbp_is_single_forum() ) : ?>
						...
						<p>
							<label for="bbp_forum_id"><?php _e( 'Category:', 'bbpress' ); ?></label><br />
							<?php
								bbp_dropdown( array(
									'show_none' => __( '-select category-', 'bbpress' ),
					...
					<?php if ( current_user_can( 'moderate' ) ) : ?>
						...
						<p>
							...
							<label for="bbp_stick_topic"><?php _e( 'Discussion Type:', 'bbpress' ); ?></label><br />
						...
						<p>
							...
							<label for="bbp_topic_status"><?php _e( 'Discussion Status:', 'bbpress' ); ?></label><br />
